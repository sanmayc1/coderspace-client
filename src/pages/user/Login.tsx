...
const UserLogin: React.FC = () => {
  ...
  return (
    <AuthFormWraper>
      <h1 className="text-2xl font-bold font-[anybody-regular] text-center py-4">Welcome Back !</h1>
      <CustomForm fields={LoginFileds} zodSchema={LoginShema} onSubmit={onSubmit} btnName="Login" />
      <p
      ...
      <div className="flex justify-center items-center pt-4 ">
        <p className="text-gray-600 text-sm select-none" onClick={() => navigate('/user/signup')}>
