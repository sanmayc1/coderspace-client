export const API_ROUTES = {
  ...
  GET_ALL_COMPANIES: (page: number, limit: string, search: string, filter: string) => `/admin/company?page=${page}&limit=${limit}&search=${search}&filter=${filter}`,
  VERIFY_COMPANY:(id:string)=>`/admin/company/${id}/verify`,
  REJECT_COMPANY:(id:string)=>`/admin/company/${id}/reject`,
