    ...
    <>
      ...
      >
        <section className="h-screen  flex flex-col justify-center items-center gap-8 ">
          <h1 className="xl:text-8xl md:text-6xl text-3xl sm:text-5xl text-center font-[anybody-regular]">
            Hey Coders,
            <br />
            Welcome to CoderSpace
          </h1>
          <p className="text-center text-xs md:text-sm xl:text-lg  text-gray-500 ">
